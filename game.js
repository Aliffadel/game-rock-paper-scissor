// document selector
const rockPlayerClass = document.querySelector(".player-rock");
const paperPlayerClass = document.querySelector(".player-paper");
const scissorPlayerClass = document.querySelector(".player-scissor");
const rockCompClass = document.querySelector(".computer-rock");
const paperCompClass = document.querySelector(".computer-paper");
const scissorCompClass = document.querySelector(".computer-scissor");
